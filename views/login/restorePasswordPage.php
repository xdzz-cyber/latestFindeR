<main>
    ...
    <form action="/clientUser/restorePassword/<?=$params['user_id']?>" method="post" class="restorePasswordPageForm text-center">
        <div class="mb-4">
            ...
            <input required type="password" class="form-control w-25 form-control-lg mx-auto" name="newPassword"  id="newPassword" aria-describedby="newPasswordHelp" placeholder="Enter you new password here">
        </div>
        <div class="mb-4">
            <label for="newPasswordRepeat" class="form-label fw-bold fs-2 mb-3">New password repeat</label>
            <input required type="password" class="form-control w-25 form-control-lg mx-auto" name="newPasswordRepeat"  id="newPasswordRepeat" aria-describedby="newPasswordRepeatHelp" placeholder="Repeat you new password here">
        </div>
